...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309192158_Cria-Banco")]
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "É úm jogo que contém bastante ação e é viciante", IdEstudio = 1, NomeJogo = "Diablo 3", Valor = 99.00m },
